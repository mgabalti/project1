...
//         document.getElementById("topbar-color-" + t).click());
//   }
//   function H() {
...
//         0 < d.value.length
//           ? (s.classList.add("show"), n.classList.remove("d-none"))
...
//           "light" == t.getAttribute("data-mode")
//             ? (C("data-bs-theme", "light", "layout-mode-light", l),
//               sessionStorage.setItem("data-layout-auto", "false"))
//             : l.hasAttribute("data-bs-theme") &&
//               "dark" == t.getAttribute("data-mode")
//             ? (C("data-bs-theme", "dark", "layout-mode-dark", l),
//               sessionStorage.setItem("data-layout-auto", "false"))
//             : l.hasAttribute("data-bs-theme") &&
...
//       n = 12 <= a ? " PM" : " AM",
//       a =
//         ("0" + (a % 12)).slice(-2) + ":" + ("0" + e.getMinutes()).slice(-2) + n;
